...
{
    public partial class GraphicsGastos : UserControl
    {
        public GraphicsGastos()
        {
            InitializeComponent();
        }
        ...
        public void CargarGraficoGastos5Dias()
        {
            try
            {
                ...
                {
                    Font = new Font("Segoe UI Emoji", 16F, FontStyle.Bold, GraphicsUnit.Point, 0),
                ...
                this.chart1.Location = new Point(-100, 0);
