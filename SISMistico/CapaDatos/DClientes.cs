...
namespace CapaDatos
{
    public class DClientes
    {
        ...
        public string InsertarClientes(Clientes cliente)
        {
            int contador = 0;
            ...
            try
            {
                ...
                SqlParameter Nombre_cliente = new SqlParameter
                {
                    ...
                    Size = 500,
                    Value = cliente.Nombre_cliente.Trim().ToUpper()
                };
                ...
                SqlParameter Telefono_cliente = new SqlParameter
                {
                    ...
                    SqlDbType = SqlDbType.VarChar,
                    Size = 50,
                    Value = cliente.Telefono_cliente.Trim().ToUpper()
                };
                ...
                SqlParameter Referencia_ubicacion = new SqlParameter
                {
                    ...
                    SqlDbType = SqlDbType.VarChar,
                    Size = 100,
                    Value = cliente.Referencia_ubicacion.Trim().ToUpper()
                };
                ...
                SqlParameter Otras_observaciones = new SqlParameter
                {
                    ...
                    SqlDbType = SqlDbType.VarChar,
                    Size = 200,
                    Value = cliente.Otras_observaciones.Trim().ToUpper()
                };
                ...
                SqlParameter Estado_cliente = new SqlParameter
                {
                    ...
                    SqlDbType = SqlDbType.VarChar,
                    Size = 50,
                    Value = cliente.Estado_cliente.Trim().ToUpper()
                };
                ...
                {
                    cliente.Id_cliente = Convert.ToInt32(SqlCmd.Parameters["@Id_cliente"].Value);
                }
            }
        ...
        public string EditarClientes(Clientes cliente)
        {
            int contador = 0;
            //asignamos a una cadena string la variable rpta y la iniciamos en vacía
            string rpta = "";
            ...
            try
            {
                ...
                SqlParameter Direccion_cliente = new SqlParameter
                {
                    ...
                    SqlDbType = SqlDbType.VarChar,
                    Size = 100,
                    Value = cliente.Direccion_cliente.Trim().ToUpper()
                };
                SqlCmd.Parameters.Add(Direccion_cliente);
                contador += 1;
